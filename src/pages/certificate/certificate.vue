<template>
	<view>
		<view class="tabs">
			<button type="default" @click="showIndex = 0"
				:class="['btn', {active: showIndex === 0}]">{{$t('certificate.title')}}</button>
			<button type="default" @click="showIndex = 1"
      ...
      <!--<iframe style="width: 100%;height: 100%" :src="pdfUrl" frameborder="0"></iframe>-->
        ...
        The core members of Ether EX are from top Internet and financial companies. The platform
        has a professional financial-grade transaction structure and a self-developed high-concurrency memory matching transaction engine. Ethernet Community Co., Ltd. has obtained the
        MSB compliance operation license in the United States and Canada.
			</view>
			...
			<view class="paragraph">
        The MSB (MoneyServiceBusiness) license is a financial license regulated by the U.S. Treasury
        Department and issued by the U.S. Treasury Department. It mainly regulates money
        service-related businesses and companies, including digital currency, virtual currency transactions, and international payment companies. Companies engaged in the above-mentioned
        related businesses in the United States must apply for an MSB license to operate legally.
			</view>
			...
			<view class="paragraph">
        FINTRAC Canada, full name FTR Canada or MSB Canada, is a Canadian financial regulator
        established in 2000 to collect, analyze, evaluate and disclose information about Canada's
        financial sector to protect Canada's financial stability and security. FINTRAC is responsible
        for collecting, analyzing, evaluating and disclosing information related to Canada's financial
        industry to protect Canada's financial stability and security.
			</view>
			<view class="sub-title">
				US stock license
			</view>
      ...
      <!--<iframe style="width: 100%;height: 100%" :src="pdfUrl2" frameborder="0"></iframe>-->
			...
			<view class="paragraph"> Ethereum community: Ethereum community Co., Ltd., the company operates the website:
        https://ethereum.org/en/ and related mobile applications (hereinafter referred to as "platform"), and based on this platform provides users with financial transactions between digital
        currencies and related Serve.</view>
			...
			<image class="img" src="../../static/img/certificate/msb1.jpg" style="height: calc((100vw - 20px)*1280/989);"
				mode="aspectFit"></image>
			<view class="sub-title">Company Name: Ethereum community Co., Ltd</view>
			...
			<view class="paragraph">
				...
				<view class="link" @click="open">
					https://www.coloradosos.gov/biz/BusinessEntityDetail.do?quitButtonDestination=BusinessEntityResults&nameTyp=ENT&masterFileId=20221447791&entityId2=20221447791&fileId=20221447791&srchTyp=ENTITY
				</view>
			</view>
			<view class="sub-title">
